...
public class animal2 extends JFrame implements ActionListener 
   {
          ...
          public void actionPerformed(ActionEvent ae)
           { 
        	  if(ae.getSource()==proceed)
        	   {
        		  ImageIcon ii = new ImageIcon("C:/Documents and Settings/Administrator/My Documents/Downloads/nagpal/src/animals/"+s[cnt]);
        		   jim=new JLabel(ii);
        		   cnt++;
