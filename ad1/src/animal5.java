...
import javax.swing.*;
 ...
 public class animal5 extends Applet implements ActionListener,ItemListener 
   {
	  Font f1=new Font("ms serif",Font.BOLD,50);
	  Image im;
	  String[] s={"dog.jpg","elephant.jpg","fox.jpg","giraffe.jpg","hippopotamus.jpg","horse.png","lion.jpg","rhinoceros.jpg","tiger.jpg","zebra.jpg","zquiz.jpg"};
      Checkbox c1,c2,c3,c4;
   
 
      CheckboxGroup cb,cb1,cb2,cb3,cb4,cb5,cb6,cb7,cb8,cb9;
      Button proceed,submit;
      int cnt=0,choice=1,flag=0,flag1=0;
      String s1;
     ...
     public void init()
         ...
         setFont(new Font("ms serif",Font.BOLD,20));
		  ...
		  submit=new Button("submit");
		    ...
		    submit.setBounds(700,550,100,100);
           ...
           { 
			          ...
			          c1.setBounds(200,500,200,50);
	        	       ...
	        	       c4.setBounds(400,550,200,50);
	        	        add(c1);
						   ...
						   c2.addItemListener(this);
						   c3.addItemListener(this);
						   c4.addItemListener(this); choice++;  
			         repaint(); break;
			 ...
			 case 11:remove(c1);
               ...
               catch(MalformedURLException e1) 
               {
        		 ...
        		 {
        			 JOptionPane.showMessageDialog(null,new String("choose the correct option please")); 
        		 }
       ...
       /* if(ae.getSource()==submit)
            ...
            public void itemStateChanged(ItemEvent ie)   
             { 
             	...
             	{
             		 JOptionPane.showMessageDialog(null,new String("choose the option"));	
             	}
              }     
